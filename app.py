...
app = create_app()
blockchain = []
paillier = Paillier(1024) # each time app starts, save the private/public key values to environment variables to easily use across the project.
...
def register():
    ...
    ct = cipher.encrypt(cipher.pad(private_key.private_bytes_raw()))
    return jsonify({
